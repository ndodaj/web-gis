...
export class AttributeDtoService extends BaseService {
  constructor(private http: HttpClient, config: AppConfigService) {
    super(config);
  }

  getAttributes(payload: any): Observable<any> {
    ...
    return this.http.get<any>(this.apiUrl + '/api/v1/attributemodelapi/', {
      params,
    });
  }
}
